...
// in simulator we redefine to format for IntramuralSports Developer console
...
{\
	NSString * exceptionName = [@"org.intramuralsports." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.intramuralsports";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIIntramuralSportsNativeItemNone = -1, 
	UIIntramuralSportsNativeItemSpinner = -2,
	UIIntramuralSportsNativeItemProgressBar = -3,
	
	UIIntramuralSportsNativeItemSlider = -4,
	UIIntramuralSportsNativeItemSwitch = -5,
	UIIntramuralSportsNativeItemMultiButton = -6,
	UIIntramuralSportsNativeItemSegmented = -7,
	
	UIIntramuralSportsNativeItemTextView = -8,
	UIIntramuralSportsNativeItemTextField = -9,
	UIIntramuralSportsNativeItemSearchBar = -10,
	
	UIIntramuralSportsNativeItemPicker = -11,
	UIIntramuralSportsNativeItemDatePicker = -12,
	
	UIIntramuralSportsNativeItemInfoLight = -13,
	UIIntramuralSportsNativeItemInfoDark = -14,
	
	UIIntramuralSportsNativeItemDisclosure = -15,
	
	UIIntramuralSportsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all IntramuralSports instances of
