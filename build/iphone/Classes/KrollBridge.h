...
@interface IntramuralSportsObject : KrollCoverageObject {
#else
@interface IntramuralSportsObject : KrollObject {
#endif
@private
...
extern NSString * IntramuralSports$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	IntramuralSportsObject *_intramuralsports;
    KrollObject* console;
	BOOL shutdown;
