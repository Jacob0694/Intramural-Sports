...
//Rare exceptions to indicate a bug in the _intramuralsports code (Eg, function that a subclass should have implemented)
...
/**
 The base class for IntramuralSports proxies.
 */
