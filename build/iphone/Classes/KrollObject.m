...
//@interface IntramuralSportsObject : NSObject
//@end

@interface IntramuralSportsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[IntramuralSportsObject class]])
		{
			for (NSString *key in [[(IntramuralSportsObject*)o modules] allKeys])
			{
