...
/**
 Base class for all IntramuralSports views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the IntramuralSports view hierarchy (such as wrapped iOS UIViews) was touched.
